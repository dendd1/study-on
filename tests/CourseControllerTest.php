...
class CourseControllerTest extends AbstractTest
{
    ...
    public function testPageSuccessful($url): void
    {
        ...
        $billingMock = new BillingMock(self::getContainer()->get(ValidatorInterface::class));
    ...
    public function testCourseFailedEditing(): void
    {
        ...
        // заполнение формы корректными значениями(кроме цены)
        $form['course[name]'] = 'Тест-имя';
        $form['course[description]'] = 'Тест-описание';
        $form[ 'course[price]'] = '0';
        $form['course[type]'] = '1';
